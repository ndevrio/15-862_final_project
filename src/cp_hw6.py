...
def computeExtrinsic(img_path, mtx, dist, dX, dY):
    ...
    print("Rmat: ", rmat)
    print("Tmat: ", cv2.Rodrigues(tvec)[0])
    ...
    cv2.putText(color_img, 'X', (int(axis_img[1,0,0]), int(axis_img[1,0,1])), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255))
    cv2.line(color_img, (int(axis_img[0,0,0]), int(axis_img[0,0,1])), (int(axis_img[1,0,0]), int(axis_img[1,0,1])), (0,0,255), 2) #x
    cv2.putText(color_img, 'Y', (int(axis_img[2,0,0]), int(axis_img[2,0,1])), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,255,0))
    cv2.line(color_img, (int(axis_img[0,0,0]), int(axis_img[0,0,1])), (int(axis_img[2,0,0]), int(axis_img[2,0,1])), (0,255,0), 2) #y
    cv2.putText(color_img, 'Z', (int(axis_img[3,0,0]), int(axis_img[3,0,1])), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255,0,0))
    cv2.line(color_img, (int(axis_img[0,0,0]), int(axis_img[0,0,1])), (int(axis_img[3,0,0]), int(axis_img[3,0,1])), (255,0,0), 2) #z
    cv2.imshow(compute_name, color_img)
    ...
    corner_rays = np.matmul(rmat.T, np.squeeze(1000*pixel2ray(image_corners, mtx, dist)).T)
    print(corner_rays)
